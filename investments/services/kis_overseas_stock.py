...
class KisOverseasStockClient:
    ...
    def algo_ordno(
        ...
        res = self.ka._url_fetch(api_url, tr_id, tr_cont, params)
    ...
    def daytime_order(
        ...
        res = self.ka._url_fetch(api_url=api_url,
                            ptr_id=tr_id,
                            tr_cont="",
                            params=params,
                            postFlag=True)
    ...
    def foreign_margin(
        ...
        # API 호출
        res = self.ka._url_fetch(api_url=api_url, ptr_id=tr_id, tr_cont=tr_cont, params=params)
    ...
    def order_resv(
        ...
        * 단 미국 예약매도주문(TTTT3016U)의 경우, MOO(장개시시장가)로 주문 접수 가능
        ...
        res = self.ka._url_fetch(api_url, tr_id, "", params, postFlag=True)
    ...
    def brknews_title(
        ...
        res = self.ka._url_fetch(api_url, tr_id, "", params)
